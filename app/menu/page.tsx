...
export default function Menu() {
  return (
    <div className="flex h-full w-full">
      <Navbar />
      <main className="flex flex-col p-20 justify-center items-center-safe h-full w-full">
        <h1 className="mt-20 text-4xl text-center font-bold">
          Bienvenido, Arian
        </h1>
          ...
          <div className="flex w-96 h-50">
            <div className="flex flex-col gap-5 justify-center items-center border-white border-2 rounded-lg p-8">
              <p className="text-center">
                Te ofrecemos un catálogo de cursos para mejorar tus habilidades
                en SQL.
              </p>
              <Link href="/courses">
